...
Build and tag the Docker image, and run the container specifying its name as "parcel-tracking-dev" to distinguish it from possible other stacks that are called "app" (the default name, based on the root directory):
